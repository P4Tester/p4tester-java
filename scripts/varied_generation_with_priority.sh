...
java -jar build/p4tester.jar -data internet2 -max $i -priority -print >>internet2.txt
done
...
java -jar build/p4tester.jar -data internet2 -routers $i -priority -print >>internet2.txt
done
